...
```{r}
# Filtro de datos
gap_cond <- lm(log_ingreso_hora~ sex_label + age + I(age^2) + max_educ_level +
...
ggplot(split_data, aes(x = Split, y = Count)) +
  ...
  labs(title = "Distribución muestra de entrenamiento y prueba",
